...
getgenv().Setting = { -- Select Weapon, Self Explain
        ...
        ["Gun"] = {["Enable"] = true, ["Delay"] = 0,

            ["Skills"] = {

                ["Z"] = {["Enable"] = true,["HoldTime"] = 0.8,["TimeToNextSkill"] = 0,},

                ["X"] = {["Enable"] = true,["HoldTime"] = 0.8,["TimeToNextSkill"] = 0,
...
loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/3b2169cf53bc6104dabe8e19562e5cc2.lua"))()
 ...
 Update: 2024-01-31 20:18:38
Report Child Abuse And Copyright (DMCA)
...
Trang Chủ |Tính Năng | Điều Khoản Sử Dụng | Chính Sách Bảo Mật
